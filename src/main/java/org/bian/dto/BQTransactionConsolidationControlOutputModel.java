...
/**
 * BQTransactionConsolidationControlOutputModel
 */
public class BQTransactionConsolidationControlOutputModel   {
  ...
  private String transactionConsolidationControlActionTaskReference = null;

  private Object transactionConsolidationControlActionTaskRecord = null;

  private String transactionConsolidationControlActionResponse = null;
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to a Transaction Consolidation instance control processing service call 
   * @return transactionConsolidationControlActionTaskReference
  **/

  public String getTransactionConsolidationControlActionTaskReference() {
    return transactionConsolidationControlActionTaskReference;
  }

  public void setTransactionConsolidationControlActionTaskReference(String transactionConsolidationControlActionTaskReference) {
    this.transactionConsolidationControlActionTaskReference = transactionConsolidationControlActionTaskReference;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Binary  general-info: The processing control service call consolidated processing record 
   * @return transactionConsolidationControlActionTaskRecord
  **/

  public Object getTransactionConsolidationControlActionTaskRecord() {
    return transactionConsolidationControlActionTaskRecord;
  }

  public void setTransactionConsolidationControlActionTaskRecord(Object transactionConsolidationControlActionTaskRecord) {
    this.transactionConsolidationControlActionTaskRecord = transactionConsolidationControlActionTaskRecord;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Text  general-info: Details of the control action service response 
   * @return transactionConsolidationControlActionResponse
  **/

  public String getTransactionConsolidationControlActionResponse() {
    return transactionConsolidationControlActionResponse;
  }

  public void setTransactionConsolidationControlActionResponse(String transactionConsolidationControlActionResponse) {
    this.transactionConsolidationControlActionResponse = transactionConsolidationControlActionResponse;
  }
